...
CREATE TABLE USUARIO(
	...
	fotografia VARCHAR(50) NOT NULL DEFAULT 'user.png',
	correo_electronico VARCHAR(50) NOT NULL,
	contrasenia VARCHAR(100) NOT NULL DEFAULT id,
...
ALTER TABLE ETIQUETA ADD CONSTRAINT fk_etiqueta_ejemplar FOREIGN KEY (id_ejemplar) REFERENCES EJEMPLAR(id);
